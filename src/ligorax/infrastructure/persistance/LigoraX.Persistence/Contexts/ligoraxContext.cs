...
namespace LigoraX.Persistence.Contexts
{
	public partial class ligoraxContext : DbContext
	{
		public static string connectionString { get; set; }

		public ligoraxContext()
		{
		}

		public ligoraxContext(DbContextOptions<ligoraxContext> options)
			: base(options)
		{
		}
